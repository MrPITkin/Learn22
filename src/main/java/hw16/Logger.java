...
public class Logger implements Runnable {
    ...
    private static final int LIFETIME = 30 * 1000; // время выполнения в мс
    ...
    @Override
    public void run() {
        System.out.printf("Ждём минутку.\nНачал работу поток %s\n", Thread.currentThread().getName());
// время работы потока ограничено 1 минутой
        while(System.currentTimeMillis() <= currentTimeMillis + LIFETIME) {
