...
public class WordReduceRunner {
    public static void main(String[] args) {
        ...
        // {"Большой", "Привет", "слушателей", "ИТ парка"}
        System.out.println(Arrays.toString(intersect(words, "привет")));
        // {"Большой", "Привет", "от", "слушателей", "ИТ парка", "от"}
    }

    private static String[] intersect(String[] initialArray, String word) {
        // int index = Arrays.binarySearch(initialArray, word); лишний поиск
