...
public class ReflectionRunner {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Все методы класса: " + carClass.getName()
                + Arrays.toString(carClass.getDeclaredMethods()));
        System.out.println("Публичные методы класса: " + carClass.getName()
                + Arrays.toString(carClass.getMethods()));
        Field[] declaredFields = carClass.getDeclaredFields();
        System.out.println("Все поля класса: " + carClass.getName() + Arrays.toString(declaredFields));
        System.out.println("Публичные поля класса: " + carClass.getName()
                + Arrays.toString(carClass.getFields()));
...
//        Car skodaFabia = carConstructor.newInstance("Skoda", "Fabia", 1.6d, 1d);
        Car skodaFabia = carConstructor.newInstance("Skoda", "Fabia", 1.6d);
...
//        Field declaredField = declaredFields[2];
        Field declaredField = declaredFields[3];
